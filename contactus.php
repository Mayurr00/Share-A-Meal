...
<body>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="http://localhost/food_donation_portal/donationform.php"><i class="fa fa-fw fa-hand-holding-heart"></i>Donation <span class="badge badge-success">6</span></a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="http://localhost/food_donation_portal/viewform.php"><i class="fa fa-fw fa-users"></i>View Donation <span class="badge badge-success">6</span></a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="http://localhost/food_donation_portal/grievance.php"><i class="fa fa-fw fa-hands-helping"></i>Grievance  <span class="badge badge-success">6</span></a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="http://localhost/food_donation_portal/contactus.php" style="background-color: rgb(241, 185, 14);"><i class="fa fa-fw fa-chart-pie"></i>Contact Us <span class="badge badge-success">6</span></a>
                            </li>
                        </ul>
                    </div>
                </nav>
            ...
            <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                             <h2 class="pageheader-title"><i class="fa fa-fw fa-tachometer-alt"></i> Contact Us </h2><div class="page-breadcrumb">
   ...
   <div class="row">
  <div class="column">
    <img src="mayur.jpg" alt="mayur" style="width:50%">
    <div class="text">
        <h4>Mayur Bhore</h4>
        <h4>+91 8779944859</h4>
        <a href = "mailto:mayur.sb@somaiya.edu?subject = Feedback&body = Message"><i><u>mayur.sb@somaiya.edu</u></i></a>
  </div>
</div>
<div class="column">
  <img src="mayank.jpg" alt="mayank" style="width:130%">
      <div class="text">
        <h4>Mayank Kulkarni</h4>
        <h4>+91 7045312962</h4>
        <a href = "mailto:mayank.kulkarni@somaiya.edu?subject = Feedback&body = Message"><i><u>mayank.kulkarni@somaiya.edu</u></i></a>
      </div>
  </div>
